...
(a=a.data.that);d("html").unbind(".dreamyTip"+a.data("dreamyTip").id);var b=a.data("dreamyTip").opts;a._isOpen=!1;a.dreamyTipElememt.animate({opacity:0},b.duration,b.easing,function(){d(this).css({zIndex:0,display:"none"});"object"==typeof b.callbackOnHide?b.callbackOnHide.f(b.callbackOnHide.params):b.callbackOnHide()})},j=function(a){var b=a.data("dreamyTip").id,c=a.data("dreamyTip").opts;c.closeButton&&"hover"!=c.event?(d("body").append('<div class="dreamyTip dt-'+c.position+'" id="dreamyTip'+b+
'"><div class="dreamyTipBtn">x</div><div class="dreamyTipInner" style="text-align:'+c.textAlign+'"></div></div>'),d("#dreamyTip"+b+" .dreamyTipBtn").bind("click",function(){e(a)})):d("body").append('<div class="dreamyTip dt-'+c.position+'" id="dreamyTip'+b+'"><div class="dreamyTipInner" style="text-align:'+c.textAlign+'"></div></div>');a.dreamyTipElememt=d("#dreamyTip"+b);c.closeWithClick&&a.dreamyTipElememt.bind("click",function(){e(a)});c.fontSize&&a.dreamyTipElememt.css("font-size",c.fontSize);
c.backgroundPosition&&a.dreamyTipElememt.css("background-position",c.backgroundPosition)},g={init:function(a){return this.each(function(){var b=d.extend({},d.fn.dreamyTip.defaults,a),c=d(this);c.dreamyTipElememt=!1;c.css("cursor",b.cursor);var f=c.attr("title");void 0!=f?c.removeAttr("title"):f="";b.msg&&(f=b.msg);c.data("dtMsg",f);c.data("dreamyTip")||c.data("dreamyTip",{opts:b,id:(new Date).getTime()});c.bind(b.event+".dreamyTip",function(){c.dreamyTipElememt||j(c);var a=c.data("dreamyTip").opts;
