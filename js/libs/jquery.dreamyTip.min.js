...
d.fn.dreamyTip.defaults,a),c=d(this);c.dreamyTipElememt=!1;b.addCursorPointer&&c.css("cursor","pointer");var f=c.attr("title");void 0!=f?c.removeAttr("title"):f="";b.msg&&(f=b.msg);c.data("dtMsg",f);c.data("dreamyTip")||c.data("dreamyTip",{opts:b,id:(new Date).getTime()});c.bind(b.event+".dreamyTip",function(){c.dreamyTipElememt||j(c);var a=c.data("dreamyTip").opts;c._isOpen?a.persistHover||e(c):""!=c.data("dtMsg")&&h(c);var a=c.data("dreamyTip"),b=a.id,f="blur"==a.opts.event;if(f)var g=0;var k=function(){c.dreamyTipElememt=
d("#dreamyTip"+b);e(c)};d("html").bind("click.dreamyTip"+b,function(){f?0<g?k():g++:k()})});b.closeOnBlur&&c.bind("blur.dreamyTip",function(){e(c)});c.bind("click.dreamyTip",function(a){a.stopPropagation()});d("html").on("click.dreamyTip",".dreamyTip",function(a){a.stopPropagation()})})},destroy:function(){return this.each(function(){var a=d(this),b=a.data("dreamyTip");d(this).unbind(".dreamyTip");d("#dreamyTip"+b.id).remove();a.removeData("dreamyTip")})},show:function(){return this.each(function(){var a=
d(this);a.data("dreamyTip");"undefined"!=a.dreamyTipElememt&&j(a);""!=a.data("dtMsg")&&h(a)})},close:function(){return this.each(function(){var a=d(this),b=a.data("dreamyTip");a.dreamyTipElememt=d("#dreamyTip"+b.id);e(a)})}};d.fn.dreamyTip=function(a){if(g[a])return g[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof a||!a)return g.init.apply(this,arguments);d.error("Method "+a+" does not exist on jQuery.dreamyTip")};d.fn.dreamyTip.defaults={addCursorPointer:!0,offsetLeftAdd:0,
offsetTopAdd:0,backgroundPosition:!1,fade:0.9,startDelay:0,duration:"medium",easing:"swing",event:"click",persistHover:!1,closeButton:!0,closeWithClick:!1,closeOnBlur:!1,autoCloseAfter:!1,position:"top",fontSize:!1,msg:!1,callbackOnShow:function(){},callbackOnHide:function(){}}})(jQuery);
