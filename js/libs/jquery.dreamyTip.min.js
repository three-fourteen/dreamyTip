...
f)})},f=function(){c._isOpen=!1;e.animate({opacity:0},a.duration,a.easing,function(){d(this).css({zIndex:0,display:"none"});a.callbackOnHide();e.unbind("clickoutside",f)})},i=function(){var b=(new Date).getTime();a.closeButton?(d("body").append('<div class="dreamyTip dt-'+a.position+'" id="dreamyTip'+b+'"><div class="dreamyTipBtn">x</div><div class="dreamyTipInner"></div></div>'),d("#dreamyTip"+b+" .dreamyTipBtn").bind("click",function(){f()})):d("body").append('<div class="dreamyTip" id="dreamyTip'+
b+'"><div class="dreamyTipInner"></div></div>');e=d("#dreamyTip"+b);a.closeWithClick&&e.bind("click",function(){f()})};"hover"==a.event?c.hover(function(){e||i();h()},function(){f()}):c.click(function(){e||i();c._isOpen?f():h()})})};d.fn.dreamyTip.defaults={addCursorPointer:!0,offsetLeftAdd:0,offsetTopAdd:0,fade:0.9,duration:"medium",easing:"swing",event:"click",closeButton:!0,closeWithClick:!1,position:"top",insertCSS:!1,callbackOnShow:function(){},callbackOnHide:function(){}}})(jQuery);